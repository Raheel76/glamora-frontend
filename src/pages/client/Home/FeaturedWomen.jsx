        ...
        <>
            <div className="relative">
                <div className="men-featured  block xs:hidden">
                    <img src="/assets/new-womenswear-at-lama.webp"  />
                </div>
                <div className="men-featured  block md:hidden">
                    <img src="/assets/new-printed-shirts-for-women.jpg" className=' size-full object-cover ' />
                </div>
                <div className="absolute md:bottom-1/3 bottom-10 left-1/2 w-full flex flex-col -translate-x-1/2 text-center">
                    ...
                    <span className='text-2xl  text-white tracking-[6px]'>All Women's Collection</span>

                    <Link to='/women' className=' text-lg font-medium  md:text-[#000000] text-white underline  '>Shop Now</Link>
                </div>
            </div>
