...
const Women = () => {
  ...
  const dressesData = products.filter(product => product.subcategory === 'Dresses' && product.category === 'Women');
  const topsData = products.filter(product => product.subcategory === 'Tops' && product.category === 'Women');
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div>
        <h1 className="text-3xl font-bold my-8 text-center">Women Dresses</h1>
      </div>
      {dressesData.length === 0 ? (
        <Empty description="No Women Dresses Available" />
      ) : (
        <div className='product-table py-4'>
          <Table
            columns={columns}
            dataSource={dressesData}
            rowKey="id"
      ...
      {/* Women Tops Section */}
      <div>
        <h1 className="text-3xl font-bold my-8 text-center">Women Tops</h1>
      </div>
      {topsData.length === 0 ? (
        <Empty description="No Women Tops Available" />
      ) : (
