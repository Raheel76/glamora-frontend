...
const AdminProfile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        setIsFormVisible(!profile.firstName); // Show form if no profile exists
      } catch (error) {
  ...
  return (
    <>
      {isFormVisible ? (
        <div className="p-6 bg-white rounded-[32px] shadow-md max-w-2xl mx-auto mt-6">
          <h2 className="text-2xl font-bold text-[#1677ff] mb-6 text-center">Admin Profile</h2>
        ...
        <Card
          title={<h2 className="text-2xl font-bold text-[#1677ff]">Admin Profile</h2>}
          extra={
